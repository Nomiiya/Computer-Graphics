...
var theta = [0, 180, 180, 180, 180, 0, 0, 0, 180, 180];
var stack = [];
var figure = [];
...
function torso(){
  ...
  for(var i =0; i<6; i++) gl.drawArrays(gl.TRIANGLE_FAN, 6*i, 4);
}
...
function initNodes(ID){
  ...
  case torsoID:
    ...
    break;
  case frontLeftLegID:
    m = translate((torsoWidth + FLLWidth), (-2.5*FLLHeight), -1.0);
